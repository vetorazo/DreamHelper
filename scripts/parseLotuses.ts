...
function generateLotusVariants(): RawLotusData[] {
  ...
  lotuses.push(
    ...
    {
      description:
        "Adds 1-3 bubbles that are the same quality as the highest-quality bubble you own (including Rainbow)",
      nightmareOmen: "Major difficulty increase",
    }
  );
  ...
  lotuses.push(
    ...
    {
      description:
        "Upgrades the quality of 1 bubble to the same quality as the highest-quality bubble you own (including Rainbow)",
      nightmareOmen: "Major difficulty increase",
    },
    {
      description:
        "Upgrades the quality of 2 bubbles to the same quality as the highest-quality bubble you own (including Rainbow)",
      nightmareOmen: "Major difficulty increase",
    }
  );
  ...
  BUBBLE_TYPES.forEach((type) => {
    ...
    lotuses.push(
      {
        description: `Adds 1 ${type} Bubble`,
        nightmareOmen: "Minor difficulty increase",
      },
      {
        description: `Adds 2 ${type} Bubbles`,
        nightmareOmen: "Minor difficulty increase",
      },
      {
        description: `Adds 1-3 ${type} Bubbles`,
        nightmareOmen: "Minor difficulty increase",
      },
      {
        description: `Adds 1 ${type} Bubble that is Blue or better`,
        nightmareOmen: "Minor difficulty increase",
      },
      {
        description: `Adds 2 ${type} Bubbles that are Blue or better`,
        nightmareOmen: "Moderate difficulty increase",
      },
      {
        description: `Adds 1-3 ${type} Bubbles that are Blue or better`,
        nightmareOmen: "Moderate difficulty increase",
      },
      {
        description: `Adds 1 ${type} Bubble that is Purple or better`,
        nightmareOmen: "Moderate difficulty increase",
      },
      {
        description: `Adds 2 ${type} Bubble that is Purple or better`,
        nightmareOmen: "Moderate difficulty increase",
      },
      {
        description: `Adds 1-3 ${type} Bubbles that are Purple or better`,
        nightmareOmen: "Significant difficulty increase",
      },
      {
        description: `Adds 1 ${type} Bubble that is the same quality as the highest-quality bubble you own (including Rainbow)`,
        nightmareOmen: "Significant difficulty increase",
      },
      {
        description: `Adds 2 ${type} Bubbles that are the same quality as the highest-quality bubble you own (including Rainbow)`,
        nightmareOmen: "Major difficulty increase",
      },
      {
        description: `Adds 1-3 ${type} Bubbles that are the same quality as the highest-quality bubble you own (including Rainbow)`,
        nightmareOmen: "Major difficulty increase",
      }
    );
    ...
    lotuses.push(
      {
        description: `Randomly selects 1 ${type} Bubble to replicate`,
        nightmareOmen: "Moderate difficulty increase",
      },
      {
        description: `Randomly selects 2 ${type} Bubbles to replicate`,
        nightmareOmen: "Significant difficulty increase",
      },
      {
        description: `Randomly selects 1-3 ${type} Bubbles to replicate`,
        nightmareOmen: "Significant difficulty increase",
      }
    );
    ...
    lotuses.push(
      {
        description: `Changes the type of 1 bubble to ${type}`,
        nightmareOmen: "Minor difficulty increase",
      },
      {
        description: `Changes the type of 2 bubbles to ${type}`,
        nightmareOmen: "Minor difficulty increase",
      },
      {
        description: `Changes the type of 3 bubbles to ${type}`,
        nightmareOmen: "Moderate difficulty increase",
      },
      {
        description: `Changes the type of 3-5 bubbles to ${type}`,
        nightmareOmen: "Moderate difficulty increase",
      },
      {
        description: `Changes the type of 1 bubble to ${type}, and then upgrades its quality by 1 tier`,
        nightmareOmen: "Moderate difficulty increase",
      },
      {
        description: `Changes the type of 2 bubbles to ${type} and upgrades their quality by 1 tier`,
        nightmareOmen: "Significant difficulty increase",
      },
      {
        description: `Changes the type of 2-3 bubbles to ${type} and upgrades their quality by 1 tier`,
        nightmareOmen: "Significant difficulty increase",
      }
    );
    ...
    lotuses.push(
      {
        description: `Removes 1 bubble and then adds 1 ${type} Bubble that is Purple or better`,
        nightmareOmen: "Moderate difficulty increase",
      },
      {
        description: `Removes 1 bubble and then adds 2 ${type} Bubbles that are Blue or better`,
        nightmareOmen: "Moderate difficulty increase",
      },
      {
        description: `Removes 1 bubble and then adds 1-3 ${type} Bubbles that are Blue or better`,
        nightmareOmen: "Significant difficulty increase",
      },
      {
        description: `Removes 1 bubble, changes the type of 1 bubble to ${type}, and then upgrades its quality by 1 tier`,
        nightmareOmen: "Significant difficulty increase",
      },
      {
        description: `Removes 1 bubble and changes the type of 2 bubbles to ${type}`,
        nightmareOmen: "Moderate difficulty increase",
      },
      {
        description: `Removes 1 bubble and changes the type of 1-3 bubbles to ${type}`,
        nightmareOmen: "Significant difficulty increase",
      }
    );
    ...
    lotuses.push(
      {
        description: `Upon entering a Nightmare, for every 3 ${type} Bubbles you have, you additionally gain 1 Red ${type} Bubble`,
        nightmareOmen: "Major difficulty increase",
      },
      {
        description: `Upon entering a Nightmare, for every 6 ${type} Bubbles you have, you additionally gain 1 Rainbow ${type} Bubble`,
        nightmareOmen: "Extreme difficulty increase",
      },
      {
        description: `Upon entering a Nightmare, for every 3 Purple or lower ${type} Bubbles you have, converts them into 1 Orange or better (including Rainbow) Whim Bubble`,
        nightmareOmen: "Major difficulty increase",
      },
      {
        description: `Upon entering a Nightmare, there is a 45% chance that the quality of all your ${type} Bubbles will be upgraded by 1 tier, up to Rainbow`,
        nightmareOmen: "Major difficulty increase",
      }
    );
  });
  ...
  lotuses.push(
    ...
    {
      description:
        "Removes 1 bubble and then adds 1 bubble that is Purple or better",
      nightmareOmen: "Moderate difficulty increase",
    },
    {
      description:
        "Removes 1 bubble and then adds 2 bubbles that are Blue or better",
      nightmareOmen: "Moderate difficulty increase",
    },
    {
      description:
        "Removes 1 bubble and then adds 1-3 bubbles that are Blue or better",
      nightmareOmen: "Significant difficulty increase",
    },
    {
      description:
        "Removes 1 bubble, then randomly upgrades the quality of 1-3 bubbles by 1 tier",
      nightmareOmen: "Moderate difficulty increase",
    }
  );
  ...
  lotuses.push(
    {
      description:
        "Upon entering a Nightmare, for every 3 different types of bubbles you have, you additionally gain 1 Red bubble of a random type",
      nightmareOmen: "Major difficulty increase",
    },
    {
      description:
        "Upon entering a Nightmare, for every 3 different types of bubbles you have, you additionally gain 1 Red Whim Bubble",
      nightmareOmen: "Major difficulty increase",
    },
    {
      description:
        "Upon entering a Nightmare, fills up the initial empty slots of the Vision with White bubbles of random types",
      nightmareOmen: "Minor difficulty increase",
    },
    {
      description:
        "Upon entering a Nightmare, fills up the initial empty slots of the Vision with Purple bubbles of a random type",
      nightmareOmen: "Significant difficulty increase",
    },
    {
      description:
        "Upon entering a Nightmare, fills up the initial empty slots of the Vision with Orange bubbles of a random type",
      nightmareOmen: "Major difficulty increase",
    },
    {
      description:
        "Upon entering a Nightmare, there is a 100% chance to upgrade the quality of each bubble by 2 tiers. For every unfilled initial empty slot, the chance is reduced by 10%",
      nightmareOmen: "Extreme difficulty increase",
    },
    {
      description:
        "Whenever the quality of a bubble changes, additionally upgrades the quality of 1 bubble by 1 tier",
      nightmareOmen: "Significant difficulty increase",
    },
    {
      description:
        "Whenever adding or removing a bubble, additionally upgrades the quality of 1 bubble by 1 tier",
      nightmareOmen: "Significant difficulty increase",
    },
    {
      description:
        "Whenever the type of a bubble changes, additionally upgrades the quality of 1 bubble by 1 tier",
      nightmareOmen: "Significant difficulty increase",
    }
  );
  ...
  lotuses.push(
    {
      description:
        "Adds 4 Rainbow bubbles. In each Dream Omen selection after this, 1 bubble will be removed (from lowest quality to highest quality)",
      nightmareOmen: "Extreme difficulty increase",
    },
    {
      description:
        "Adds 1 bubble, but no more bubbles can be added later. Upon entering a Nightmare, each bubble is additionally replicated 1 time",
      nightmareOmen: "Major difficulty increase",
    },
    {
      description:
        "Removes bubbles until leaving only 1 random bubble of each type, then changes their quality to Orange",
      nightmareOmen: "Extreme difficulty increase",
    },
    {
      description:
        "Removes bubbles until only 1 random bubble is left, then changes its quality to Red and replicates 1 copy of it",
      nightmareOmen: "Extreme difficulty increase",
    },
    {
      description:
        "Randomly changes the type of all bubbles, and then randomly changes the quality of all bubbles, reducing their quality by at most 1 tier or upgrading their quality by at most 2 tiers",
      nightmareOmen: "Major difficulty increase",
    },
    {
      description:
        "Randomly changes the quality of 1 bubble, reducing their quality by at most 1 tier or upgrading their quality by at most 2 tiers",
      nightmareOmen: "Minor difficulty increase",
    },
    {
      description:
        "The quality of bubbles can't be changed anymore. Upon entering a Nightmare, you additionally obtain a number of Whim Bubbles equal to the number of bubbles you already have",
      nightmareOmen: "Extreme difficulty increase",
    },
    {
      description:
        "Upon entering a Nightmare, you additionally gain all the bubbles that have been removed in the Sweet Dreams of this round",
      nightmareOmen: "Major difficulty increase",
    },
    {
      description:
        "Removes half your bubbles (rounding down) and replicates your remaining bubbles, with the chance to upgrade their quality by 1 tier",
      nightmareOmen: "Major difficulty increase",
    }
  );
  ...
  lotuses.push(
    {
      description:
        "Adds 1 White bubble and locks it. During each omen selection, its quality is upgraded by 1 tier, up to Rainbow",
      nightmareOmen: "Moderate difficulty increase",
    },
    {
      description:
        "Adds 1 Rainbow bubble and locks it. During each omen selection, its quality is reduced by 1 tier",
      nightmareOmen: "Minor difficulty increase",
    },
    {
    ...
    {
      description:
        "Adds 1 Rainbow Bubble that will be removed during the next omen selection",
      nightmareOmen: "Minor difficulty increase",
    },
    {
      description:
        "Removes the highest quality bubble and replicates 2 copies of it in the next omen selection",
      nightmareOmen: "Moderate difficulty increase",
    }
  );
