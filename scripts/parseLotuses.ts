...
import type { LotusEffect, BubbleType, BubbleQuality } from '../src/types/index.js';
...
function parseDescription(description: string): LotusEffect['effect'] {
  ...
  if (lowerDesc.includes('adds')) {
    ...
    const count = countMatch 
      ? (countMatch[2] ? [parseInt(countMatch[1]), parseInt(countMatch[2])] : parseInt(countMatch[1]))
      : 1;
    
    // TYPE NARROWING: Determine specific quality based on keywords
    let quality: BubbleQuality | 'highest' | 'purple_or_better' | 'blue_or_better' | undefined;
    ...
    else if (lowerDesc.includes('purple or better')) quality = 'purple_or_better';
...
const manualLotusData: RawLotusData[] = [
  ...
  { description: 'Adds 1 Gear Bubble', nightmareOmen: 'Minor difficulty increase' },
  { description: 'Adds 2 Gear Bubbles', nightmareOmen: 'Minor difficulty increase' },
  { description: 'Adds 1-3 Gear Bubbles', nightmareOmen: 'Minor difficulty increase' },
  { description: 'Adds 1 Gear Bubble that is Blue or better', nightmareOmen: 'Minor difficulty increase' },
  { description: 'Adds 2 Gear Bubbles that are Blue or better', nightmareOmen: 'Moderate difficulty increase' },
  { description: 'Adds 1-3 Gear Bubbles that are Blue or better', nightmareOmen: 'Moderate difficulty increase' },
  { description: 'Adds 1 Gear Bubble that is Purple or better', nightmareOmen: 'Moderate difficulty increase' },
  { description: 'Adds 2 Gear Bubble that is Purple or better', nightmareOmen: 'Moderate difficulty increase' },
  { description: 'Adds 1-3 Gear Bubbles that are Purple or better', nightmareOmen: 'Significant difficulty increase' },
  
  // Type changes
  { description: 'Changes the type of 1 bubble to Gear', nightmareOmen: 'Minor difficulty increase' },
  { description: 'Changes the type of 2 bubbles to Gear', nightmareOmen: 'Minor difficulty increase' },
  { description: 'Changes the type of 3 bubbles to Gear', nightmareOmen: 'Moderate difficulty increase' },
  { description: 'Changes the type of 1 bubble to Gear, and then upgrades its quality by 1 tier', nightmareOmen: 'Moderate difficulty increase' },
  { description: 'Changes the type of 2 bubbles to Gear and upgrades their quality by 1 tier', nightmareOmen: 'Significant difficulty increase' },
  ...
  { description: 'Adds 1 Blacksail Bubble', nightmareOmen: 'Minor difficulty increase' },
  { description: 'Adds 1 Cube Bubble', nightmareOmen: 'Minor difficulty increase' },
  { description: 'Adds 1 Commodity Bubble', nightmareOmen: 'Minor difficulty increase' },
  { description: 'Adds 1 Netherrealm Bubble', nightmareOmen: 'Minor difficulty increase' },
  { description: 'Adds 1 Fluorescent Bubble', nightmareOmen: 'Minor difficulty increase' },
  { description: 'Adds 1 Whim Bubble', nightmareOmen: 'Minor difficulty increase' },
];
